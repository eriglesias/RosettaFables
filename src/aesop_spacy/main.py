...
def main():
    ...
    try:
        ...
        if args.only_analyze:
            ...
            _print_analysis_summary(logger, analysis_results)
            ...
            pipeline.run()
            analysis_results = pipeline.analyze()
            _save_analysis_summary(output_dir, analysis_results)
            _print_analysis_summary(logger, analysis_results)
...
def _print_analysis_summary(logger, results):
...
def _save_analysis_summary(output_dir, results):
    ...
    try:
        ...
        logging.error("Failed to save analysis summary: %s", e)
